    ...
    function renderVehicleInspector(vehicle) {
            ...
            <div class="inspector-form">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="insp-passengers" value="${vehicle.passengers || 0}" min="0">
                    </div>
                    <div class="form-group">
                        <label>Capacity</label>
                        <input type="number" id="insp-capacity" value="${vehicle.capacity || 40}" min="1">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
        ...
        bindSave('insp-save', () => {
            ...
            return Commands.updateVehicle(vehicle.id, {
                ...
                passengers: parseInt(val('insp-passengers')) || 0,
                capacity: parseInt(val('insp-capacity')) || 40,
                moving: moving,
                color: val('insp-color'),
