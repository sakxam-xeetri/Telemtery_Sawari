...
| Passengers         | `0`    | ∞     | Vehicles                      | `vehicle-validator.php`        |
| Capacity           | `1`    | ∞     | Vehicles                      | `vehicle-validator.php`        |
...
| `passengers`    | `0`             | Vehicles                | `vehicle-validator.php`     |
| `capacity`      | `40`            | Vehicles                | `vehicle-validator.php`     |
...
| Variant             | URL                                                                      |
| ------------------- | ------------------------------------------------------------------------ |
| Default (all modes) | `https://tile.openstreetmap.org/{z}/{x}/{y}.png`                         |
...
| Constant                    | Value                              | Location                  | Description                                  |
| --------------------------- | ---------------------------------- | ------------------------- | -------------------------------------------- |
| GPS API path                | `hardware-api/gps.php`             | `hardware-api/test.php`   | GPS telemetry endpoint                       |
| Passenger API path          | `hardware-api/passenger.php`       | `hardware-api/test.php`   | Passenger counting endpoint                  |
| GPS max latitude            | `90`                               | `gps.php`                 | Latitude validation upper bound              |
| GPS min latitude            | `-90`                              | `gps.php`                 | Latitude validation lower bound              |
| GPS max longitude           | `180`                              | `gps.php`                 | Longitude validation upper bound             |
| GPS min longitude           | `-180`                             | `gps.php`                 | Longitude validation lower bound             |
| Max image size              | `10` MB                            | `passenger.php`           | Camera image upload size limit               |
| Allowed image types         | `image/jpeg`, `image/png`, `image/webp` | `passenger.php`      | Accepted image MIME types                    |
| OpenRouter model            | `google/gemini-2.0-flash-001`      | `passenger.php`           | Vision AI model for people counting          |
| OpenRouter max tokens       | `100`                              | `passenger.php`           | Response limit for counting                  |
| GPS auto-simulate interval  | `3,000` ms                         | `test.php`                | Simulator GPS fix interval                   |
| GPS lat drift range         | `±0.0008`                          | `test.php`                | Random lat drift per simulation tick         |
| GPS lng drift range         | `±0.001`                           | `test.php`                | Random lng drift per simulation tick         |
